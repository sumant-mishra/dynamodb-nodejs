...
module.exports = function (router) {
    ...
    // GET: List of active projects
	router.get('/internships/status', function (req, res) { 
        Proposal.aggregate([
            /* {
                $lookup:
                {
    ...
    // GET: List of active projects
	router.get('/internships/assessment', function (req, res) { 
        Proposal.aggregate([
            /* {
                $lookup:
                {
    ...
    // PUT: Updates existing one doc...
	router.post('/internships/status', function (req, res) {
        console.log(req.body);
        let internshipStatusItems = req.body.data;
        console.log(req.body);
        let results = [];
    ...
    // DELETE: Deletes one doc...
	router.delete('/internships/status/:ids', function (req, res) {
